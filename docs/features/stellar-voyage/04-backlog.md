...
> - **▶️ 다음 = 이색 천체 (G-c-9)** — 우선순위 1순위로 확정 (2026-06-15, 탐험·수집 다양성 임팩트 최대). `/yc:brainstorm` 선행.
...
9. **▶️ 이색 천체: 블랙홀·성운·펄서 등 — 다음 작업 (1순위, 2026-06-15 확정)** — 별 분포·종류 변경 = **GEN_VERSION 범프**(구현 시점 배정, 다음=5 예정) + 골든 재생성. 탐험·수집 다양성 임팩트가 가장 커서 사실성 v2보다 우선. `/yc:brainstorm` 선행 필수.
    ...
    **선행 필요:** `/yc:brainstorm "이색 천체 — 블랙홀·펄서·성운: 종류·분포·표현·게임플레이"`
