...
1. ~~**배경 은하**~~ — ✅ 완료 (2026-06-11, 결정 24): `scenes/shared/DistantGalaxies` 절차 스머지 빌보드 8장, 은하·별계 씬 공용.
2. ~~**워프 연출 다듬기**~~ — ✅ 완료 (2026-06-11, 결정 26): 스트리크 2층화 + 중앙 글로우 + FOV 큐빅 서지 + 플래시 청백 틴트. 타임라인 구조 불변.
...
6. ~~**항성계 배경 별**~~ — ✅ 완료 (2026-06-11, 결정 25): `scenes/system/SystemBackdropStars` 실제 이웃 별 셸 투영, 시드 결정론 유지.
